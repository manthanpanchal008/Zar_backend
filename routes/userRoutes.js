...
router.get('/users', requireLogin, requireWebRole('admin'), async (req, res) => {
  try {
...
router.get('/users/add', requireLogin, requireWebRole('admin'), async (req, res) => {
...
router.post('/users/add', requireLogin, requireWebRole('admin'), async (req, res) => {
...
router.get('/users/edit/:id', requireLogin, requireWebRole('admin'), async (req, res) => {
  const { id } = req.params;
  try {
    const roles = await listUserRoles();
...
router.post('/users/edit/:id', requireLogin, requireWebRole('admin'), async (req, res) => {
  const { id } = req.params;
...
router.post('/users/delete/:id', requireLogin, requireWebRole('admin'), async (req, res) => {
  const { id } = req.params;

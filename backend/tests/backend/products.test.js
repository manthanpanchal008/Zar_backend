...
jest.mock('../../models/collectionTypeModel', () => ({
  listCollectionTypes: jest.fn().mockResolvedValue([]),
  listCollectionTypesForSelection: jest.fn().mockResolvedValue([{ id: 30, name: 'Handmade' }]),
  findCollectionTypeById: jest.fn().mockResolvedValue({ id: 30, name: 'Handmade' }),
}));
